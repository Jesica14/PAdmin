/* Generated from the user-provided Plat-Admn-201 PDF. Answers and explanations are preserved as provided in the source. */
window.EXAM_QUESTIONS = [
  ...
  },
  {
    ...
    "options": {
      "A": "Use a conditional filter in the screen element to only show the Specific Search Engine field only when Lead Source is \"Search Engine\".",
      "B": "Use Assignment elements; one for when Lead Source is \"Search Engine\" and one for everything else.",
  ...
  {
    "id": 11,
    "question": "Ursa Major Solar's Platform Administrator is editing the page layout for a new custom object. A text area field is accidentally removed from the page layout, and it needs to be restored to the page layout. What are two methods for achieving this goal?",
    "options": {
      "A": "Clone the layout from a different profile and use save as.",
      "B": "Restore original page layout from a sandbox.",
      "C": "Restore from the recycle bin within 15 days.",
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "Every time the administrator runs a prompt template in Prompt Builder, it creates a unique call to the large language model.",
      "C": "The prompt is only sent to the large language model after the administrator deploys the template to a live agent, not when the prompt is run in the builder.",
  ...
  },
  {
    ...
    "options": {
      "A": "Two permission sets, one record type, one picklist",
      "B": "One record type, two profiles, one picklist",
  ...
  },
  {
    ...
    "explanation": "The Salesforce AppExchange is a vast marketplace designed to extend the functionality of a Salesforce organization through various types of solutions. Components: Administrators can find pre-built Lightning Components (A) to enhance record pages, such as custom maps, weather widgets, or specialized data entry forms. These can be dragged and dropped directly in the Lightning App Builder. Consultants: The AppExchange also serves as a directory for certified Salesforce Consultants (D). This allows organizations to find and vet professional partners who specialize in specific industries or technical implementations to help them scale their Salesforce instance. While \"Communities\" (Option C) refers to a Salesforce product (now Experience Cloud), you don't \"find\" them on the AppExchange to enhance an org; rather, you might find packages to enhance them. \"Customers\" (Option B) are not a solution found on the marketplace. By leveraging the AppExchange, a Platform Administrator can quickly implement proven solutions without the need for extensive internal development."
  },
  {
    "id": 34,
    "question": "Sales managers would like to know what could be implemented to surface important values based on the stage of the opportunity? Which tool should a Platform Administrator use to meet this requirement?",
    "options": {
      "A": "Workflow Rules",
      "B": "Path Key Fields",
  ...
  {
    "id": 49,
    "question": "DreamHouse Realty has an approval process. A manager attempts to approve a record but receives an error. What should a Platform Administrator do to troubleshoot this issue?",
    "options": {
  ...
  },
  {
    ...
    "explanation": "To provide reps with an \"easy way\" to perform a repetitive sequence of manual tasks, Macros are the ideal solution. A Macro allows a user to perform multiple steps--such as changing a Case Status, reassigning the Case Owner, and sending a pre-written email--with a single click. When combined with Quick Actions, Macros can navigate the user interface, populate fields, and submit changes automatically. This significantly reduces manual data entry and ensures that the company's required support process is followed consistently. Case Assignment Rules (Option A) and Autolaunched Flows (Option D) are fully automated and trigger on save, which might not be appropriate if the rep needs to decide when to trigger the support request. Quick Text (Option C) only assists with typing but does not automate field changes or ownership transfers."
  },
  {
    "id": 56,
  ...
  },
  {
    ...
    "explanation": "The Opportunity Sales Path (or simply Path) is a visual representation of the stages in a sales process. It is the best tool for this requirement because it not only shows the current stage prominently at the top of the record but also allows administrators to define Key Fields and Guidance for Success for every stage. This guidance can include specific steps, tips, and links to company resources that explain exactly what a rep needs to do to move the deal to the next phase. Reports (Option A), List Views (Option D), and Big Deal Alerts (Option C) provide data and notifications but do not offer the contextual, stage-by-stage guidance that the Path provides."
  },
  {
    "id": 61,
  ...
  },
  {
    ...
    "explanation": "To \"undo\" a mistaken import, the administrator must delete the incorrectly created records. Two standard tools facilitate this: Mass Delete Records (Option D): This is a browser-based tool in Setup that allows administrators to delete up to 250 records at a time (standard) or use criteria to identify and remove larger sets of records. It is the quickest way for smaller mistakes. Data Loader (Option B): For large-scale errors, the administrator can use the Success file generated during the original import (which contains the new record IDs) and perform a \"Delete\" operation. The Data Import Wizard (Option C) is for adding or updating data, but it does not have a \"Delete\" function. Weekly Data Export (Option A) is a backup tool and cannot be used to remove existing data from the system."
  },
  {
    "id": 73,
  ...
  },
  {
    ...
    "explanation": "To track specific stages of a support process and measure the time elapsed within those stages, Salesforce provides Entitlements and Milestones. Milestones represent required steps in a support process, such as \"First Response Time\" or \"Resolution Time\". When combined with Business Hours, Milestones allow the system to accurately calculate how long a case has been in a particular status or assigned to a specific team, excluding weekends or non-working hours. This provides leadership with granular reporting on \"Team Performance\" and SLA compliance. Escalation Rules (Option A) and Assignment Rules (Option C) are primarily routing tools; they can move a case but do not natively provide the timestamp-based tracking and reporting necessary to see duration across multiple \"handoffs\". Record-Triggered Flows (Option B) could theoretically be used to stamp fields, but this would require significant custom development and would not offer the native, out-of-the-box reporting dashboards that come with the Milestones feature. Therefore, Entitlement Management is the standard solution for tracking time-based service metrics."
  },
  {
    "id": 94,
    "question": "A Platform Administrator at Cloud Kicks needs to export a file of closed won opportunities from the last 90 days. The file should include the Opportunity Name, ID, Close Date, and Amount. What should the administrator use to export this file?",
    "options": {
      "A": "Data Loader",
      "B": "Data Import Wizard",
      "C": "Data Cloud Connection",
  ...
  },
  {
    ...
    "explanation": "Account Teams are designed specifically for \"collaborative selling,\" allowing multiple users to work together on a single Account. By using Account Teams, an administrator can define specific roles (e.g., Sales Engineer, Support Rep) and grant them varying levels of access (Read/Write or Read Only) to the Account and its related Opportunities and Case. To meet the manager's requirement of \"streamlining\" and \"automatically adding\" members, the administrator should encourage users to set up Default Account Teams. Once a user defines their default team in their personal settings, they can click a single button to add that entire team to any Account they own. Sharing Rules (Option B) are typically too broad for this requirement because they apply to all records meeting a criteria, rather than specific collaborative groups. The Role Hierarchy (Option C) provides vertical access but doesn't easily handle the horizontal, project-based access required for support reps and engineers working on specific accounts. Permission Sets (Option D) grant functional permissions (what a user can do) but do not grant access to specific data records in a collaborative way."
  },
  {
    "id": 97,
    ...
    "options": {
      "A": "Lightning pages and Visualforce pages automatically appear in the Mobile Only navigation menu without requiring tabs to be created first.",
      "B": "The Mobile Only app can be customized to show different navigation menus for different user profiles and permission sets.",
  ...
  {
    "id": 103,
    "question": "What are two capabilities of Salesforce Knowledge? Choose 2 answers.",
    "options": {
      "A": "Users can rate the helpfulness of articles",
      "B": "Knowledge articles integrate with Service Console.",
      "C": "Knowledge articles are always publicly available for customers.",
  ...
  {
    "id": 104,
    "question": "A Delegated Administrator at Universal Containers cannot edit the Created Date field for the Account record. What reason should the System Administrator give for why this is occurring?",
    "options": {
  ...
  {
    "id": 105,
    "question": "Ursa Major Solar is adding objects to a custom report type. How many objects, maximum, can be added to this report type?",
    "options": {
      "A": "Unlimited as long as the objects have associations",
      "B": "Four as long as the objects have associations",
      "C": "One as long as the object has a master-child relationship",
      "D": "Two as long as the objects have associations"
    },
    "answer": [
      "B"
    ],
  ...
  },
  {
    ...
    "explanation": "Grounding is the process by which an AI agent retrieves and uses specific, trusted data to ensure its responses are accurate and relevant. During this process, Salesforce's Einstein Trust Layer performs several critical checks, including identifying Prompt Injection risks. Prompt injection refers to attempts by a user to \"trick\" the AI into ignoring its instructions or revealing sensitive data by entering malicious commands into the chat interface. By checking for these risks during the grounding phase, the agent can ensure that the instructions it uses to generate a response remain secure and aligned with company policies. While the agent respects field security, \"Encrypted fields\" (Option C) are handled at the data access layer rather than as part of the linguistic grounding check. Standard Agentforce agents do not browse the open web for verification (Option D) as they are intended to remain grounded strictly in the company's verified internal data."
  },
  {
    "id": 112,
  ...
  },
  {
    ...
    "options": {
      ...
      "B": "Create a Dashboard with widgets specific to each team.",
  ...
  },
  {
    ...
    "options": {
      "A": "Create a screen flow that runs anytime an opportunity is closed.",
  ...
  },
  {
    ...
    "options": {
      ...
      "D": "Make the opportunity stage a dependent picklist to the Lead source."
    },
    "answer": [
      "C"
    ],
    "explanation": "A Validation Rule is the correct tool for enforcing conditional data entry requirements. When a business rule dictates that a field (Lead Source) must be populated only when another field (Stage) reaches a specific value (Closed Won), a validation rule can evaluate this logic every time a record is saved. The formula would check if the Stage is \"Closed Won\" and simultaneously check if the Lead Source field is blank. If both conditions are true, the system displays an error message and prevents the user from saving the record. This ensures 100% data compliance. Dependent picklists (Options A and D) are used to filter available options in one list based on the selection of another, but they cannot \"require\" a value to be present based on a stage change in the same way a validation rule can. Making the stage \"Read Only\" (Option B) would prevent users from ever winning a deal. Validation rules are the standard method for maintaining data quality during critical transitions in the sales lifecycle."
  },
  {
    "id": 118,
    "question": "The administrator at Universal Containers is creating a flow with several steps. How can the administrator check their work as they are developing the flow?",
    "options": {
  ...
  {
    "id": 119,
    "question": "Which two actions allow the System Administrator to limit Chatter access during roll-out to a subset of Salesforce users? Choose 2 options.",
    "options": {
      "A": "Create an email invitation for the subset of users.",
      "B": "Edit a Profile to \"Enable Chatter\" for the subset of users.",
      "C": "Add the subset of users to the company-wide Chatter group.",
      "D": "Create a Permission Set with the \"Enable Chatter\" permission for the subset of users."
    },
    "answer": [
      "B",
      "D"
  ...
  {
    "id": 120,
    "question": "A user's profile can be controlled by which three settings? Choose 3 options.",
    "options": {
      "A": "Feature license assignment",
      "B": "Record type assignment",
      "C": "Locale settings",
      "D": "Security at the field-level",
      "E": "Assigned apps"
    },
    "answer": [
      "B",
  ...
  },
  {
    ...
    "options": {
      ...
      "C": "There will be no data loss with use of a global value set.",
  ...
  },
  {
    ...
    "explanation": "A Master-Detail Relationship is a tight coupling between two objects that provides several unique functionalities: Master Object Types: The master can be either a standard object (like Account) or a custom object (Option B). Roll-up Summaries: This relationship type is the only one that natively supports Roll-up Summary fields, allowing the master record to calculate counts, sums, or averages of fields on the detail records (Option C). Ownership and Security: The detail record inherits its owner and its security/sharing settings from the master record. Consequently, there is no \"Owner\" field on a detail record; it is always owned by the owner of the master (Option D). Option A is incorrect because detail records cannot have independent permissions. Option E is incorrect because an object can only have a maximum of two master-detail relationships. This relationship is ideal for parent-child scenarios where the child's existence is entirely dependent on the parent."
  },
  {
    "id": 128,
  ...
  },
  {
    ...
    "explanation": "When a user needs to be temporarily prevented from logging in--but their records, role, and historical data need to remain intact--the best practice is to Freeze the user. Freezing an account stops the user from accessing the system immediately without \"Deactivating\" them. Deactivation can be problematic if the user is a \"running user\" for dashboards or is part of active hierarchy logic that might break if the account is disabled. Freezing is a simple \"one-click\" action on the user record. Reassigning the license (Option A) would require deactivating the user first. Changing login hours (Option B) or IP addresses (Option D) at the profile level would impact all users assigned to that profile, not just the individual manager on leave. Freezing provides a targeted and temporary solution for managing individual user access."
  },
  {
    "id": 130,
    "question": "Universal Containers regularly imports Accounts from an external order system that has its own ID field for each record. What should the System Administrator do to help prevent duplicates during these imports?",
    "options": {
      "A": "Use VLOOKUP to find matching records in Salesforce.",
      "B": "Create a unique External ID field on Accounts in Salesforce for matching.",
      "C": "Create a formula field that identifies matches.",
      "D": "Use the ID from the order system in place of the Salesforce ID."
    },
    "answer": [
      "B"
    ],
  ...
  {
    "id": 132,
    "question": "Ursa Major Solar is using products and price books. Which two items should an administrator take into considerations about these features? Choose 2 options.",
    "options": {
      "A": "Products without a price are automatically added to the standard price book.",
      "B": "If price books contain assets, they can NOT contain products.",
  ...
  },
  {
    ...
    "explanation": "The Kanban view provides a visual representation of a set of records, such as an opportunity pipeline, organized by a specific field like \"Stage\". It allows sales teams to see all their deals as cards in columns. The primary benefit of Kanban is its \"drag-and-drop\" functionality, which lets users move a card from one column to another to automatically update the stage, effectively \"moving opportunities forward\" with minimal effort. While reports (Option A) and dashboards (Option B) provide visual summaries, they do not allow for the interactive, one-click record updates that the Kanban view offers. Standard list views (Option D) show data in a grid format which is less visual for tracking pipeline progress compared to the column-based Kanban layout."
  },
  {
    "id": 139,
    ...
    "explanation": "Mobile Home is a customizable landing page for the Salesforce mobile app that acts as the default \"start page\" for users. It allows administrators to add various \"cards\" or \"widgets,\" including reports, pinned records, and upcoming events. By enabling and configuring Mobile Home, a Platform Administrator can place a specific Report card (such as \"Top Opportunities\") at the very top of the screen, ensuring it is the first thing users see upon opening the app. While adding the Reports tab (Option A) or Dashboards tab (Option D) allows users to find the information, it does not automatically present specific report data on the home screen. The \"Today\" feature (Option B) focuses on calendar events and tasks rather than customized reporting data."
  },
  {
    "id": 140,
  ...
  {
    "id": 142,
    "question": "Universal Containers has two sales teams, sales team A and sales team B. Each team has their own role in the role hierarchy. Both roles are subordinates of the same Manager role. How should a Platform Administrator share records owned by sales team A with sales team B?",
    "options": {
  ...
  {
    "id": 151,
    "question": "Ursa Major Solar wants to assist users with a guided expense report process to simplify submissions, routing, and authorizations. Which two tools should a Platform Administrator use to build this solution?",
    "options": {
      "A": "Validation Rule",
      "B": "Quick Action",
      "C": "Flow Builder",
  ...
  },
  {
    ...
    "explanation": "Flow Builder is the standard and most versatile tool for performing automated data maintenance, including the deletion of records. A \"Schedule-Triggered Flow\" can be configured to run at specific intervals (e.g., daily at midnight) to find records that meet certain criteria--such as Leads that have been \"Unqualified\" for over a year--and use the \"Delete Records\" element to remove them from the system. While the \"Mass Delete Records\" tool (Option C) exists in the Setup menu, it is a manual administrative tool and cannot be scheduled or fully automated based on complex field-level logic. Automation Studio (Option B) is a Marketing Cloud tool, not a core Salesforce platform feature for record management. Flow Orchestration (Option D) is used for complex, multi-user business processes rather than simple data cleanup tasks. Therefore, for recurring, criteria-based record deletion, Flow Builder is the recommended solution."
  },
  {
    "id": 153,
  ...
  },
  {
    ...
    "explanation": "The Lightning App Builder is the primary tool for creating custom user interfaces in both the desktop and mobile versions of Salesforce. For mobile customization, administrators primarily focus on two page types: App Page: These are custom \"landing pages\" or \"home pages\" for an app. They can contain a mix of components like lists, charts, and flows, and they appear as items in the mobile navigation menu. Record Page: These allow administrators to customize the layout of a specific object (like an Account or a custom Property record) for mobile users. Admins can use \"Component Visibility Rules\" to show or hide specific sections when the record is viewed on a mobile device, ensuring a streamlined experience on smaller screens. There is no such thing as a \"User Page\" (Option B) in the App Builder. While dashboards can be viewed on mobile, they are created in the Dashboard Builder, not the Lightning App Builder (Option D). About Lead2pass .com Lead2pass.com was founded in 2006. We provide latest & high quality IT Certification Training Exam Questions, Study Guides, Practice Tests. Lead the way to help you pass any IT Certification exams, 100% Pass Guaranteed or Full Refund. Especially Cisco, Microsoft, CompTIA, Citrix, EMC, HP, Oracle, VMware, Juniper, Check Point, LPI, Nortel, EXIN and so on. Our Slogan: First Test, First Pass. Help you to pass any IT Certification exams at the first try. You can reach us at any of the email addresses listed below. Sales:  sales@lead2pass.com Support:  support@lead2pass.com Technical Assistance Center:  technology@lead2pass.com Any problems about IT certification or our products, you could rely upon us, we will give you satisfactory answers in 24 hours. View list of all certification exams: http://www.lead2pass.com/all-products.html"
  }
];
